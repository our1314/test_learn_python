...
datasets_train = ImageFolder("D:/desktop/XRay毛刺检测/TO252样品图片/TO252编带好品/ROI/cls/train", transform=transform_train)
datasets_val = ImageFolder("D:/desktop/XRay毛刺检测/TO252样品图片/TO252编带好品/ROI/cls/val", transform=transform_val)

# dataloader_train = DataLoader(datasets_train, 10, shuffle=True)cls
