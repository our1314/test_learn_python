...
datasets_train = ImageFolder("D:/work/files/deeplearn_datasets/x-ray/cls-dataset/sc89/train", transform=transform_train)
datasets_val = ImageFolder("D:/work/files/deeplearn_datasets/x-ray/cls-dataset/sc89/val", transform=transform_val)
