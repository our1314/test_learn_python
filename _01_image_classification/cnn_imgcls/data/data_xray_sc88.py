...
datasets_train = ImageFolder("D:/work/files/deeplearn_datasets/x-ray/cls-dataset/sc88/train", transform=transform_train)
datasets_val = ImageFolder("D:/work/files/deeplearn_datasets/x-ray/cls-dataset/sc88/val", transform=transform_val)
