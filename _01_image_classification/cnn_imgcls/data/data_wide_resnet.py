...
# class Dataset_wide_resnet(Dataset):
...
datasets_train = ImageFolder('D:/work/files/deeplearn_datasets/choujianji/roi-mynetseg/test/test4', transform=trans_train)
datasets_val = ImageFolder('D:/work/files/deeplearn_datasets/choujianji/roi-mynetseg/test/test4', transform=trans_val)
