...
transform_train = torchvision.transforms.Compose([
    ...
    torchvision.transforms.RandomRotation(6, expand=False, interpolation=InterpolationMode.BILINEAR),
...
datasets_train = ImageFolder("D:/work/files/deeplearn_datasets/x-ray/cls-dataset/sot23_juanpan/train", transform=transform_train)
datasets_val = ImageFolder("D:/work/files/deeplearn_datasets/x-ray/cls-dataset/sot23_juanpan/val", transform=transform_val)
